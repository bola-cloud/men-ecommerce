        ...
        <div class="v2-ctx-section" data-section="settings">
            ...
            @if (Helpers::module_permission_check('system_settings'))
                <div class="v2-ctx-group">
                    ...
                    <a class="v2-nav-item {{ (Request::is('admin/system-setup/environment-setup') || Request::is('admin/system-setup/app-settings') || Request::is('admin/system-setup/app-deep-link') || Request::is('admin/system-setup/sitemap') || Request::is('admin/system-setup/currency/view') || Request::is('admin/system-setup/web-config/db-index') || Request::is('admin/system-setup/language*') || Request::is('admin/system-setup/software-update') || Request::is('admin/system-setup/web-config/app-settings') || Request::is('admin/system-setup/invoice-settings/') || Request::is('admin/system-setup/db-index')) ? 'v2-is-active' : '' }}" data-item="system-setup" href="{{ route('admin.system-setup.app-settings') }}">
